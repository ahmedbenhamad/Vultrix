...
Notable integration skills:
- `pentest_rag` (custom): external Pentest RAG connection/query protocol for grounded exploitation guidance after recon, with a Metasploit-module-first execution handoff
