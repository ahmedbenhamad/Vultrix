...
class Config:
    ...
    strix_image = "strix-sandbox:0.7.2"
    strix_runtime_backend = "docker"
    # Raised from 120 -> 300 so exploit_research can wait the full 120s for the
    # RAG /query (generation is slow) plus the Metasploit search in one call
    # without the sandbox tool-server killing the tool mid-flight.
