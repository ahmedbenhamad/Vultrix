...
import { FileText, FileDown, FileJson, Sheet } from "lucide-react";
...
export default function ReportsPage() {
  ...
  return (
    <div>
      <PageHeader title="Reports" description="Generated assessment reports, exportable to PDF, CSV or JSON." />
              ...
              <CardContent className="p-5">
                ...
                {can("report:export") && r.assessment_id && (
                  <div className="mt-4 flex gap-2">
                    <Button size="sm" variant="outline" onClick={() => downloadExport(r.assessment_id!, "pdf")}>
                      <FileDown className="h-3.5 w-3.5" /> PDF
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => downloadExport(r.assessment_id!, "csv")}>
                      <Sheet className="h-3.5 w-3.5" /> CSV
                    </Button>
                    <Button size="sm" variant="outline" onClick={() => downloadExport(r.assessment_id!, "json")}>
